    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="">Add Page Numbers</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl ">Add Page Numbers</h1>
        ...
        {!file ? (
          ...
          >
            ...
            <div className="mb-4 rounded-2xl bg-[var(--card)]  p-4 shadow-sm group-hover:scale-110 transition-transform">
              <Hash className="h-8 w-8 text-[var(--accent)]" />
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--card)]  p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm ">Ready to add numbers</p>
                </div>
              </div>
              <button 
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)]  p-8 shadow-sm">
              <div className="mb-6 flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold ">Numbering Settings</h3>
              </div>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-bold  mb-2">Start Number</label>
                    <input 
                      type="number"
                      value={startNumber}
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl bg-[var(--card)]  p-4 border border-gray-100">
                    <p className="text-xs font-bold  mb-2 uppercase tracking-widest opacity-50">Preview</p>
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-[var(--border)] p-6">
            ...
            <h3 className="mb-2 font-bold ">Auto Numbering</h3>
            <p className="text-sm  opacity-60">Automatically add sequential numbers to every page of your document.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">🎨</div>
            <h3 className="mb-2 font-bold ">Custom Format</h3>
            <p className="text-sm  opacity-60">Choose your own text format, starting number, and position on the page.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold ">100% Private</h3>
            <p className="text-sm  opacity-60">Your files are processed locally in your browser. No data ever leaves your device.</p>
          </div>
        </div>
      </div>
    </div>
