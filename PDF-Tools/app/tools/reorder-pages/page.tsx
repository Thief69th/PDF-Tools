    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-5xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="">Reorder Pages</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl ">Reorder Pages</h1>
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--card)]  p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm ">{thumbnails.length} Pages detected</p>
                </div>
              </div>
              <button 
            ...
            {isRendering ? (
              <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className=" font-medium">Generating page previews...</p>
              </div>
            ) : (
              <div className="space-y-8">
                <Reorder.Group 
                ...
                >
                  {thumbnails.map((thumb) => (
                    ...
                    >
                      <div className="aspect-[3/4] overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)]  shadow-sm transition-all group-hover:border-black">
                        <img 
                          src={thumb.url} 
                      ...
                      <p className="mt-2 text-center text-[10px] font-bold  opacity-50 uppercase tracking-widest">
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-[var(--border)] p-6">
            ...
            <h3 className="mb-2 font-bold ">Drag & Drop</h3>
            <p className="text-sm  opacity-60">Easily rearrange pages by dragging them into your preferred order.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">🖼️</div>
            <h3 className="mb-2 font-bold ">Visual Previews</h3>
            <p className="text-sm  opacity-60">See high-quality thumbnails of every page to make reordering simple.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold ">Private & Secure</h3>
            <p className="text-sm  opacity-60">All page rendering and reordering happens locally in your browser.</p>
          </div>
        </div>
      </div>
    </div>
