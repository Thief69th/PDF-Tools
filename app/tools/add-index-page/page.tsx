    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="text-black dark:text-white">Add Index Page</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl text-black dark:text-white">Add Index Page</h1>
        ...
        {!file ? (
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white dark:bg-gray-800 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-black dark:text-white">Ready to add index</p>
                </div>
              </div>
              <button 
            ...
            <div className="rounded-3xl border border-gray-200 bg-white dark:bg-gray-800 p-8 shadow-sm">
              <div className="mb-8">
                <label className="block text-sm font-bold text-black dark:text-white mb-2">Index Title</label>
                <input 
                  type="text"
                  value={indexTitle}
                  onChange={(e) => setIndexTitle(e.target.value)}
                  className="w-full rounded-xl border border-gray-200 p-4 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-black text-black dark:text-white"
                />
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold text-black dark:text-white uppercase tracking-widest opacity-50">Index Items</h3>
                  <button 
                    onClick={addItem}
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-100 p-6">
            ...
            <h3 className="mb-2 font-bold text-black dark:text-white">Professional Look</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Add a clean Table of Contents to your documents for better navigation.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">✍️</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">Fully Customizable</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Control the title, item names, and page numbers of your index.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">Private Processing</h3>
            <p className="text-sm text-black dark:text-white opacity-60">All page generation happens locally in your browser. No data is uploaded.</p>
          </div>
        </div>
      </div>
    </div>
