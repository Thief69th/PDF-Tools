    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="">Add Index Page</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl ">Add Index Page</h1>
        ...
        {!file ? (
          ...
          >
            ...
            <div className="mb-4 rounded-2xl bg-[var(--card)]  p-4 shadow-sm group-hover:scale-110 transition-transform">
              <LayoutList className="h-8 w-8 text-[var(--accent)]" />
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--card)]  p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm ">Ready to add index</p>
                </div>
              </div>
              <button 
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[var(--card)]  p-8 shadow-sm">
              <div className="mb-8">
                <label className="block text-sm font-bold  mb-2">Index Title</label>
                <input 
                  type="text"
                  value={indexTitle}
                  onChange={(e) => setIndexTitle(e.target.value)}
                  className="w-full rounded-xl border border-[var(--border)] p-4 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-[var(--accent)] "
                />
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold  uppercase tracking-widest opacity-50">Index Items</h3>
                  <button 
                    onClick={addItem}
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-[var(--border)] p-6">
            ...
            <h3 className="mb-2 font-bold ">Professional Look</h3>
            <p className="text-sm  opacity-60">Add a clean Table of Contents to your documents for better navigation.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">✍️</div>
            <h3 className="mb-2 font-bold ">Fully Customizable</h3>
            <p className="text-sm  opacity-60">Control the title, item names, and page numbers of your index.</p>
          </div>
          <div className="rounded-2xl border border-[var(--border)] p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold ">Private Processing</h3>
            <p className="text-sm  opacity-60">All page generation happens locally in your browser. No data is uploaded.</p>
          </div>
        </div>
      </div>
    </div>
