    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="text-black dark:text-white">Add Page Numbers</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl text-black dark:text-white">Add Page Numbers</h1>
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white dark:bg-gray-800 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-black dark:text-white">Ready to add numbers</p>
                </div>
              </div>
              <button 
            ...
            <div className="rounded-3xl border border-gray-200 bg-white dark:bg-gray-800 p-8 shadow-sm">
              <div className="mb-6 flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-black dark:text-white">Numbering Settings</h3>
              </div>

              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-bold text-black dark:text-white mb-2">Position</label>
                    <select 
                      value={position}
                  ...
                  <div>
                    <label className="block text-sm font-bold text-black dark:text-white mb-2">Start Number</label>
                    <input 
                      type="number"
                      value={startNumber}
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-bold text-black dark:text-white mb-2">Format</label>
                    <input 
                      type="text"
                      value={format}
                      ...
                      className="w-full rounded-xl border border-gray-200 p-3 text-sm focus:outline-none focus:ring-2 focus:ring-black text-black dark:text-white"
                    />
                    <p className="mt-2 text-[10px] text-black dark:text-white opacity-60">
                      Use <code className="font-bold">{'{n}'}</code> for page number and <code className="font-bold">{'{total}'}</code> for total pages.
                    </p>
                  </div>
                  
                  <div className="rounded-2xl bg-gray-50 dark:bg-gray-900 p-4 border border-gray-100">
                    <p className="text-xs font-bold text-black dark:text-white mb-2 uppercase tracking-widest opacity-50">Preview</p>
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-100 p-6">
            ...
            <h3 className="mb-2 font-bold text-black dark:text-white">Auto Numbering</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Automatically add sequential numbers to every page of your document.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">🎨</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">Custom Format</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Choose your own text format, starting number, and position on the page.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">100% Private</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Your files are processed locally in your browser. No data ever leaves your device.</p>
          </div>
        </div>
      </div>
    </div>
