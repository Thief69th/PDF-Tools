    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="text-black dark:text-white">Add Watermark</span>
        </nav>
        ...
        {!file ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-8 shadow-sm space-y-6">
