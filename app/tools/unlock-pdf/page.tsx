    ...
    <div className="container-custom py-12 md:py-20">
      <div className="mx-auto max-w-4xl">
        <nav className="mb-8 flex items-center gap-2 text-sm font-medium opacity-50">
          ...
          <ArrowRight size={14} />
          <span className="text-black dark:text-white">Unlock PDF</span>
        </nav>

        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl text-black dark:text-white">Unlock PDF</h1>
        ...
        {!file ? (
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white dark:bg-gray-800 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-black dark:text-white">Enter password to unlock</p>
                </div>
              </div>
              <button 
            ...
            <div className="mx-auto max-w-md space-y-6 rounded-3xl border border-gray-200 bg-white dark:bg-gray-800 p-8 shadow-sm">
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 rounded-full bg-indigo-50 p-4 text-indigo-600">
                  <Lock size={32} />
                </div>
                <h3 className="text-xl font-bold text-black dark:text-white">Password Required</h3>
                <p className="mt-2 text-sm text-black dark:text-white opacity-60">
              ...
              <div className="space-y-4">
                <input 
                  ...
                  className="w-full rounded-xl border border-gray-200 p-4 text-sm focus:outline-none focus:ring-2 focus:ring-black text-black dark:text-white"
                />
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="rounded-2xl border border-gray-100 p-6">
            ...
            <h3 className="mb-2 font-bold text-black dark:text-white">Remove Passwords</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Instantly remove owner passwords and open passwords from your PDF documents.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">✂️</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">Remove Restrictions</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Unlock restricted actions like printing, copying text, or modifying the document.</p>
          </div>
          <div className="rounded-2xl border border-gray-100 p-6">
            <div className="mb-4 text-2xl">🔒</div>
            <h3 className="mb-2 font-bold text-black dark:text-white">100% Private</h3>
            <p className="text-sm text-black dark:text-white opacity-60">Password processing happens locally in your browser. We never see your passwords or files.</p>
          </div>
        </div>
      </div>
    </div>
